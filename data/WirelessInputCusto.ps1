...
$applicationName="WirelessInput"
$shortApplicationName="WInput"
$templatesWithCustoFiles=@{
    ...
    "status.html"=@{
        ...
        ;
        HTMLContent=@'
        <h2 class="content-subhead">Input<span id="l3"><h6 style="display:inline"><b> Loading...</b></h6></span></h2>
        Input state : <span id="input"></span><br>
        Last Jeedom Result : <span id="ljr"></span><br>
'@
        ;
        HTMLScriptInReady=@'
        ...
        .fail(function(){
            $("#l3").html('<h4 style="display:inline"><b> Failed</b></h2>');
        });
'@
    }
    ;
    ...
    "config.html"=@{
        ...
        ;
        HTMLContent=@'
        <h2 class="content-subhead">Input<span id="l1"><h6 style="display:inline"><b> Loading...</b></h6></span></h2>
    ...
    <div id='j' style='display:none'>
        ...
        <div class="pure-control-group">
        <label for="ci">Command Id</label>
            <input type='number' id='ci' name='ci' min='0' max='65535'>
            <span class="pure-form-message-inline">(Jeedom Virtual Command Id)</span>
        </div>
        <div id='jf'>
            <div class="pure-control-group">
